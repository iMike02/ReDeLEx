...
if __name__ == "__main__":
    ...
    # Mode selection
    parser.add_argument("--mode", choices=["train", "tune"], default="train",help="Run mode: train (single run) or tune (hyperparameter search)")
    ...
    parser.add_argument("--aggr", choices=["sum", "mean", "max"], default="sum", help="Aggregation function")
    parser.add_argument("--norm", choices=["batch_norm", "layer_norm"], default="batch_norm", help="Normalization type")
    ...
    parser.add_argument("--max_steps_per_epoch", type=int, default=10, help="Max steps per epoch")
    
    # Data processing config
    parser.add_argument("--process_bridge", action="store_true", default=False, help="Process bridge tables")
    parser.add_argument("--bridge_strategy", choices=["default", "keep_attributes", "keep_table"], default="default")
    parser.add_argument("--process_hub", action="store_true", default=False, help="Process hub tables")
    parser.add_argument("--hub_strategy", choices=["default_combinations", "keep_attributes", "keep_table"], default="default_combinations")
    ...
    parser.add_argument("--mlflow_experiment", type=str, default="gnn_experiment", help="MLflow experiment name")
    parser.add_argument("--aim_repo", type=str, default=None, help="Aim repo path")
    parser.add_argument("--num_samples", type=int, default=1, help="Number of trials for tuning")
    parser.add_argument("--num_gpus", type=float, default=0, help="Number of GPUs per trial")
    parser.add_argument("--num_cpus", type=int, default=1, help="Number of CPUs per trial")
    parser.add_argument("--tune_config", type=str, default=None,help="Path to JSON file with Ray Tune search space overrides")
